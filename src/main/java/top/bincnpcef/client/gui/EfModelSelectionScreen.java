package top.bincnpcef.client.gui;
...
public class EfModelSelectionScreen extends GuiNPCInterface {
    ...
    public EfModelSelectionScreen(Screen parent, String title, List<String> options, Consumer<String> action) {
